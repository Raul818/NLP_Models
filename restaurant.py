...
classes = ["Sentiment",'Taste', 'Variety', 'Drinks', 'Service', 'Value', 'Hygiene', 'Ambience', 'Hospitality', 'Comforts', 'Entertainment']


lem = WordNetLemmatizer()

path1 = r"/home/repusight/Desktop/Ammis_foodpanda_crawled/25-apr-17/merged.csv"

data = pd.read_csv("/home/repusight/Desktop/master_ammis_21April_17.csv")
...
def sentiment_process():
    ...
    for cls in classes:
        ...
        test[cls] = prediction
        #print(test)
    test.to_csv("/home/repusight/Desktop/Ammis_foodpanda_crawled/ammis_foodpanda_classified", '|', encoding='utf-8', index=False, header=True)
